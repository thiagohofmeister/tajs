...
export default class View {
  ...
  updateList(items) {
    const template = ({ imageUrl, title }) =>
      `<article class="col-md-12 col-lg-4 col-sm-3 top-30"><div class="card"><figure><img class="card-img-top card-img"src="${imageUrl}"alt="Image of an ${title}"><figcaption><h4 class="card-title">${title}</h4></figcaption></figure></div></article>`
